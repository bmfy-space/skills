...
```text
.developemnt-plan/<topic>-YYYY-MM-DD/design.md
.developemnt-plan/<topic>-YYYY-MM-DD/plan.md
.developemnt-plan/<topic>-YYYY-MM-DD/todo.md
```

同一主题的 `design.md`、`plan.md` 和 `todo.md` 必须显示在同一个 `<topic>-YYYY-MM-DD` 文件夹中，便于查看和更新。

其中 `<topic>` 使用短横线命名，日期使用创建或更新该计划当天的 `YYYY-MM-DD`：

```text
.developemnt-plan/image2-workbench-2026-05-14/design.md
.developemnt-plan/image2-workbench-2026-05-14/plan.md
.developemnt-plan/image2-workbench-2026-05-14/todo.md
```
...
2. 如果已有相似计划，更新既有 `<topic>-YYYY-MM-DD` 文件夹中的 `design.md`、`plan.md` 和 `todo.md`；不要创建重复主题文件夹
3. 如果没有相似计划，创建 `.developemnt-plan/<topic>-YYYY-MM-DD/`
